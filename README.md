...
| 제출 항목 | 어디를 보면 되나 |
|---|---|
| 1 소스코드 | `src/` 구현체 · `Dockerfile` · `requirements.txt` · 이 문서의 환경 구성과 실행 명령어 |
| 2 기술 제안서 | `docs/` 아래 제안서 문서 |
| 3 평가용 API 서버 정보 | End-point `http://211.188.57.111:8000` · 명세는 `docs/API.md` · 서버가 살아 있으면 `/docs` 와 `/openapi.json` |
